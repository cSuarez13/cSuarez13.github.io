...
export default function Contact() {
  ...
  return (
    <Layout
      title="Contact - Claudia Suarez"
      description="Get in touch with Claudia Suarez"
    >
      <div className="container mx-auto px-4 pt-16 pb-24 max-w-6xl">
        ...
        >
          ...
          <p className="text-lg text-dark-600 dark:text-dark-300 max-w-2xl mx-auto">
            Have a question, job opportunity, or want to collaborate on a
            project? Fill out the form below and I&apos;ll get back to you as
            soon as possible.
          </p>
        </div>
        ...
        {formStatus.isSubmitted && (
          <div className="mb-8 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg flex items-start">
            <CheckCircle
              className="flex-shrink-0 text-green-500 dark:text-green-400 mr-3"
              size={24}
            />
            <div>
        ...
        {formStatus.isError && (
          <div className="mb-8 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg flex items-start">
            <XCircle
              className="flex-shrink-0 text-red-500 dark:text-red-400 mr-3"
              size={24}
            />
            <div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-6">
              ...
              <div>
                <label
                  htmlFor="name"
                  className="block text-dark-700 dark:text-dark-300 font-medium mb-2 flex items-center"
                >
                  <User
                    size={18}

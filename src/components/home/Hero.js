...
import { Code, Terminal, Database, ChevronDown } from 'lucide-react';
      ...
      <div className={`transform transition-all duration-1000 ${inView ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-center">
            <span className="text-purple-700 dark:text-purple-400">Claudia Suarez</span>
          </h1>
        ...
        <div className="flex justify-center mt-12 space-x-6">
          <div className="flex flex-col items-center transition-all duration-300 hover:transform hover:scale-110">
            ...
            <span className="mt-2 text-dark-600 dark:text-dark-300">Software Development</span>
          </div>
          ...
          <div className="flex flex-col items-center transition-all duration-300 hover:transform hover:scale-110">
            ...
            <span className="mt-2 text-dark-600 dark:text-dark-300">Data Science</span>
          </div>
          ...
          <div className="flex flex-col items-center transition-all duration-300 hover:transform hover:scale-110">
            ...
            <span className="mt-2 text-dark-600 dark:text-dark-300">Database Management</span>
          </div>
        </div>
        ...
        <div className="mt-16 flex justify-center w-full">
          ...
          >
            <span className="text-sm mb-2 group-hover:underline">Learn more about me</span>
            <ChevronDown 
              size={24} 
